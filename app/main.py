...
def init_router():
    return stx.Router({"/": home, "/list": show_list, "/detail": detail})
...
def show_list():
    ...
    for d in result:
        ...
        # @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        print("\n>>>>>>> id:", id)
        detail_button = b.button("Show Detail", key=id)
        print(">>>>>>> detail_button:", detail_button)
        st.write("<hr>", unsafe_allow_html=True)
        if detail_button:
            ...
            st.session_state["report_path"] = (
                "Z:\\이초운_중1_2023\\탐구보고서 검색 프로젝트\\reports"
            )
